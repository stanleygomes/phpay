...
<form class="search-form formulary" method="post" action="{{ route('app.store.search') }}">
    {!! csrf_field() !!}
    <div class="row mt-4">
        <div class="col-sm-9">
    ...
    <div class="mt-3">
        ...
        <div class="row p-3 mb-1 border-bottom">
            ...
            <div class="col-sm-3 text-right">
                ...
                <a href="{{ route('app.store.delete', [ 'id' => $store->id ]) }}" class="not-underlined confirmAction" data-message="Deseja deletar o endereço {{ $store->name }}?">
