...
<!-- LIGHTBOX MODAL DO MERCADO PAGO -->
...
<form enctype="multipart/form-data" action="{{ route('mercadoPago.preview') }}" method="POST">
    <script src="https://www.mercadopago.com.br/integrations/v1/web-payment-checkout.js" data-header-color="#c0392b" data-elements-color="#81ecec" data-button-label="Pagar" data-preference-id="<?php echo $preference->id; ?>">
    </script>
</form>
