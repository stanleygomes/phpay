...
<p>Olá <strong>{{ $user->name }}</strong>, sua conta foi criada com sucesso. A senha de acesso foi gerada pelo sistema e segue abaixo.</p>

<p>Email: <strong>{{ $user->email }}</strong></p>
<p>CPF/CNPJ: <strong>{{ $user->cpfcnpj }}</strong></p>
