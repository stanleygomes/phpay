    ...
    <div class="row mt-4">
        <div class="col-sm-9">
            <div class="form-group">
                ...
                <input type="text" id="inputTitle" name="title" class="form-control" placeholder="Título" value="{{ $filter ? $filter['title'] : old('title') }}">
            </div>
        </div>
        <div class="col-sm-3">
    ...
    <div class="mt-3">
        ...
        <div class="row p-3 mb-1 border-bottom">
            ...
            <div class="col-sm-3 text-right">
                ...
                <a href="{{ route('app.featured.delete', [ 'id' => $featured->id ]) }}" class="not-underlined confirmAction" data-message="Deseja deletar o endereço {{ $featured->name }}?">
