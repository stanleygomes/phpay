...
<a class="visible-xs">
    <i class="fa fa-bars button-icon icon-20"></i>
</a>
@endsection
...
<div class="container pb-5">
    <div class="row">
        <div class="col-sm-3">
            <a class="visible-xs not-underlined" data-toggle="collapse" href="#collapseMenu" role="button" aria-expanded="false" aria-controls="collapseMenu">
